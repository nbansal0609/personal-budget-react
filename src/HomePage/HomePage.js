...
// Register the PieController and other necessary components
...
function HomePage() {
    ...
    function createD3JSChart() {
      if (d3ChartRef.current) {
        ...
        const g = svg.append("g")
          .attr("transform", "translate(" + width / 2 + "," + (height / 2 + spaceBetweenLegendAndChart) + ")");
  ...
  return (
    <main className="center" id="main">
      ...
      <h1>D3JS Chart</h1>
      <figure>
        <svg ref={d3ChartRef} width="500" height="500" id="donutChart"></svg>
